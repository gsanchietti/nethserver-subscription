...
if ($view['SystemId']) {
   ...
   echo '<div class="Buttonlist"><a id="regNowBtn" href="'.$view['SubscriptionUrl'].'?action=newServer" target="_blank" title="'.$T('subscriptions_plans').'" role="button" aria-disabled="false">'.$T('subscriptions_plans').'</a>';
