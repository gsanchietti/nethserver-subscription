...
$L['RegistrationKey_label'] = 'Registration key';
$L['error_network_registration_key'] = 'The key cannot be verified now: the remote procedure has failed';
$L['error_invalid_registration_key'] = 'The given key has been rejected (${0})';
